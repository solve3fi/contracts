...
use crate::{manager::swap_manager::PostSwapUpdate, state::Solve};

use super::{transfer_from_owner_to_vault_v2, transfer_from_vault_to_owner_v2};

#[allow(clippy::too_many_arguments)]
pub fn update_and_swap_solve_v2<'info>(
    solve: &mut Account<'info, Solve>,
...
#[allow(clippy::too_many_arguments)]
pub fn update_and_two_hop_swap_solve_v2<'info>(
    // update
    swap_update_one: &PostSwapUpdate,
    swap_update_two: &PostSwapUpdate,
    // solve
    solve_one: &mut Account<'info, Solve>,
    solve_two: &mut Account<'info, Solve>,
    // direction
