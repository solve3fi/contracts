...
impl Tick {
    ...
    /// Check that the tick index is a valid start tick for a tick array in this solve
    ...
    ///
    /// # Returns
    /// - `true`: The tick index is a valid start-tick-index for this solve
    /// - `false`: The tick index is not a valid start-tick-index for this solve
