...
pub enum ErrorCode {
    ...
    #[msg("Tick-array already exists in this solve")]
    ...
    #[msg("This solve only supports full-range positions")]
    FullRangeOnlyPool, // 0x17a6 (6054)

    #[msg("Too many supplemental tick arrays provided")]
    TooManySupplementalTickArrays, // 0x17a7 (6055)
    #[msg("TickArray account for different solve provided")]
    DifferentSolveTickArrayAccount, // 0x17a8 (6056)
