...
/*
  Opens a new Solve Position with Mint and TokenAccount owned by Token-2022.
*/
pub fn handler(
    ...
    if with_token_metadata {
        let (name, symbol, uri) = build_position_token_metadata(position_mint, position, solve);
